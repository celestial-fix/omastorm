...
route GRAMET. Aerodromes are identified from AWC stationinfo (and a
Chile ICAO table), so SCTB shows at Tobalaba even when the live METAR
box only lists SCEL. In Chile, MeteoChile (DMC) supplies those reports
